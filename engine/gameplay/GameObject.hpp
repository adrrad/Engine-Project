...
friend class Gameplay::Scene;
friend class Gameplay::ComponentManager;
private:
    GameObjectID ID;

    Scene* m_scene;
    
    std::unordered_map<std::string, Gameplay::BaseComponent*> m_components;
    ...
    __forceinline const std::unordered_map<std::string, Gameplay::BaseComponent*> GetComponents();
...
const std::unordered_map<std::string, Gameplay::BaseComponent*> GameObject::GetComponents()
{
    return m_components;
}
...
inline T* GameObject::AddComponent()
{
    ...
    T* component = Gameplay::ComponentManager::AddComponent<T>();
    Gameplay::BaseComponent* comp = dynamic_cast<Gameplay::BaseComponent*>(component);
