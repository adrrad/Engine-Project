...
{
    return EngineSubsystem<Renderer>::GetSubsystemAllocator()->New<Shader>(GetAbsoluteResourcesPath("\\shaders\\line_shader.vert"), GetAbsoluteResourcesPath("\\shaders\\line_shader.frag"));
}
