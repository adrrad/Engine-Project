...
void MeshComponent::UpdateMaterialData() 
{
    ...
    m_material->SetProperty<glm::mat4x4>("InstanceUniforms", "ViewModel", MV);
    m_material->SetProperty<glm::mat4x4>("InstanceUniforms", "Model", M);
    m_material->SetProperty<glm::mat4x4>("InstanceUniforms", "InvT", ITM);
    m_material->SetProperty<glm::mat4x4>("InstanceUniforms", "MVP", MVP);
}
...
Geometry::Volume* MeshComponent::GetBoundingVolume()
{
