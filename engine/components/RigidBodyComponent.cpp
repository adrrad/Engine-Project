...
void RigidBodyComponent::Initialize(Physics::ColliderInfo& colInfo, float mass)
{
    colInfo.Transform = gameObject->transform;
    if(m_physicsManager == nullptr) m_physicsManager = Physics::PhysicsManager::GetInstance();
